<template>
    <div class="container">
        <transition name="fade" mode="out-in">
            <img :src="currentImg" :key="currentImg" alt="Dynamic Image" class="background-img">
        </transition>
        <div class="options">
            <p @mouseover="changeImg('img1')" @click="chooseSeat" class="option">座位预定</p>
            <p @mouseover="changeImg('img2')" @click="chooseDish" class="option">菜品选择</p>
        </div>
    </div>
</template>
